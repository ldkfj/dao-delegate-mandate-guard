...
| Non-final safety case: owner creates mandate #1 | `FINALIZED / SUCCESS` | `0x8c9646d94d1af03d9781a096669fbf8964907957048bd07cf5a3c72a02791ed8`; Explorer confirms sender `0xeF5D2119416A2f5afa35dCFA209766EFC1BE5902`, target contract `0xC500A12309784a75367FC53aCfa54c0F231A26d1`, and return value `1` |
...
The corrected wallet chooser visibly shows only human-facing names (`OKX Wallet` and `MetaMask` in the
inspected session); `io.metamask` and `com.okex.wallet` are absent from rendered chooser text. The
automated provider matrix still covers the exact supported set including Rabby.
